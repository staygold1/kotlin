...
public interface KProperty2<D, E, out R> : KProperty<R>, (D, E) -> R {
     ...
     * for more information.
     *
     * In case of the extension property in a class, [receiver] should be the instance of the class, not the extension receiver.
     *
     * @param receiver the receiver which is used to obtain the value of the property delegate.
     */
    @SinceKotlin("1.1")
    public fun getDelegate(receiver: D): Any?
