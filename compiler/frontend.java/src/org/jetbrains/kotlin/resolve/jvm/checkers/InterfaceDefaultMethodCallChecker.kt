...
class InterfaceDefaultMethodCallChecker : CallChecker {
    ...
    override fun check(resolvedCall: ResolvedCall<*>, reportOn: PsiElement, context: CallCheckerContext) {
        ...
        val invocationDescriptorOwner = descriptor.original.containingDeclaration

        if (invocationDescriptorOwner is ClassDescriptor && isInterface(invocationDescriptorOwner) ) {
